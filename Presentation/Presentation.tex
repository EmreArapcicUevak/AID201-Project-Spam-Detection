...
\begin{document}
    ...
    \subsection{Performance Analysis}
        \begin{frame}{Confusion Matrix}
            \centering
            \includegraphics[height=0.8\textheight]{Images/ConfusionMatrix}
        \end{frame}

        \begin{frame}{ROC Curve}
            \centering
            \includegraphics[height=0.9\textheight]{Images/ROC_Curve}
        \end{frame}

        \begin{frame}{Classification Report}
            \centering
            \input{Tables/Classification_Report_Table}
        \end{frame}

    \subsection{Try it out!}
    \begin{frame}{Try out the model!}
        \centering
        \qrcode[height=0.6\textheight]{https://aid201-project-spam-detection.streamlit.app}
    \end{frame}
\end{document}